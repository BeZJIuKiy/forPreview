...
import {GraphForPreview} from "../GraphForPreview";


const EngineIcon = () => (
    <Icon path={mdiGaugeFull}
        // title="User Profile"
          size={1}
        // horizontal
        // vertical
...
const VibrationIcon = () => <Icon path={mdiVolumeVibrate} size={1}/>
                ...
                return (
                    <div style={{display: "flex", flexDirection: "column"}}>
                        ...
                        <div style={{
                            ...
                            <div>
                                {/*<Button variant="contained" style={{marginBottom: 10, background: "#f44336"}}>*/}
    ...
    return (
        <div className={classes.root}>
            <AppBar position="static" color="default">
                ...
                >
                    <Tab label="Out Pressure Sensor 01" icon={<EngineIcon/>} {...a11yProps(0)} />
                    <Tab label="Vibration Sensor 01" icon={<VibrationIcon/>} {...a11yProps(1)} />
